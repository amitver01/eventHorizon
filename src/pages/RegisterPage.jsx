...
export default function RegisterPage() {
  ...
  async function registerUser(ev){
    ...
    try{
      await axios.post('https://backend-event-qj0c.onrender.com/api/auth/register', {
        name,
        email,
        password,
  ...
  return (
    ...
    <div className ="flex w-full h-full lg:-ml-24 px-10 py-10 justify-between place-items-center mt-12">
      <div className= "hidden lg:flex  left-box ">
      <div className='ml-96 gap-3'>
        <div className='text-6xl font-extrabold leading-14 text-black'>Welcome to 
          <span className="text-blue-700 gap-3"> eveHorizon</span>
          </div>
        <div className='flex justify-center'>
          <img src="../src/assets/welcome.svg" alt="vv" className="w-64 items-start"/>
        </div>
      </div>
